...
1. The input data is scaled using `StandardScaler`.
2. A GA evolves candidate neural network architectures.
3. Each architecture is trained briefly and evaluated on validation MSE.
4. The best-performing architecture is retrained more thoroughly.
5. The final model and scalers are saved for future predictions.
6. A CLI script loads the saved artifacts and produces tax revenue forecasts.
